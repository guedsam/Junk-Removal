            ...
            {services.map((service, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-8 hover:shadow-lg transition-shadow duration-300">
                ...
                <div className="border-t border-gray-200 pt-4 flex justify-between items-center">
                  ...
                  <Link 
                    href={service.link} 
                    className="inline-flex items-center px-4 py-2 bg-primary-600 text-white text-sm font-medium rounded-lg hover:bg-primary-700 transition-colors duration-200 whitespace-nowrap"
                  >
                    Learn More
